...
func setupPlotHoleFixtures(t *testing.T, pool *pgxpool.Pool) (models.Universe, models.Chapter, models.Entity) {
	...
	universe := models.Universe{ID: uuid.New(), UserID: user.ID, Name: "PH Universe", Format: "novel"}
	work := models.Work{ID: uuid.New(), UniverseID: universe.ID, Title: "PH Work", Type: "book", OrderIndex: 1, Status: "in_progress"}
